...
Each assignment is organized in a separate folder with its own source code, documentation, and README (where applicable).
...
MirAI-Internship/
│
├── Assignment 1 - Calculator Using Streamlit/
├── Assignment 2 - The Identity Echo Interface/
├── Assignment 3/
├── Assignment 4/
├── ...
└── README.md
...
> New assignments and projects will be added throughout the internship.
...
- Practice clean coding and project organization.
